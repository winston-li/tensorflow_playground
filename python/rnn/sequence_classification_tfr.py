...
def run():
    ...
    output_file = os.path.join(data_dir, 'Sequence_classification.tfr')
    ...
    file_list = [os.path.join(os.getcwd(), 'sequence_classification_data', 'Sequence_classification.tfr')]
    print(file_list)
