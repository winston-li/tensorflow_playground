...
def run():
    ...
    evaluate(model_dir, data_dir, log_dir, drone_input.DataTypes.validation, 5000 / BATCH_SIZE)
    print('Test accurary:')
    evaluate(model_dir, data_dir, log_dir, drone_input.DataTypes.test, 10000 / BATCH_SIZE)
    print('Train accurary:')
    evaluate(model_dir, data_dir, log_dir, drone_input.DataTypes.train, 55000 / BATCH_SIZE)
